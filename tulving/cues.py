...
# create bateches of prompts for recognition ("reco") and recall
# ("reca") tests.
...
TBR_WORDS = [
    ('free', 'unbound', 'three'),
    ('sleet', 'snowfall', 'fleet' ), 
    ('small', 'big', 'shawl'),
    ('produce', 'farm', 'reduce'),
    ('grape', 'wine', 'drape'),
    ('cobweb', 'gossamer', 'web'),
    ('library', 'book', 'arbitrary'),
    ('chair', 'table', 'stair'),
    ('walk', 'run', 'talk'),
    ('cart', 'drag', 'dart'),
    ('stitch', 'sew', 'switch'),
    ('side', 'face', 'ride'),
    ('locket', 'brooch', 'rocket'),
    ('move', 'stay', 'groove'),
    ('egg', 'overeasy', 'peg'),
    ('sneeze', 'cold', 'tease'),
    ('faucet', 'spigot', 'trinket'),
    ('volcano', 'eruption', 'chicano'),
    ('toy', 'play', 'joy'),
    ('mass', 'pile', 'grass'),
    ('recess', 'break', 'express'),
    ('bead', 'pearl', 'head'),
    ('ant', 'fly', 'coolant'),
    ('cover', 'overlay', 'clover'),
    ('hen', 'chicken', 'yen'),
    ('hat', 'lid', 'fat'),
    ('pet', 'deary', 'set'),
    ('map', 'geography', 'lap'),
    ('control', 'ensure', 'enroll'),
    ('pain', 'grief', 'vein'),
    ('cushion', 'soften', 'fashion'),
    ('monkey', 'ape', 'honky'),
